...
locals {
  access_entries = merge({ for name, user in local.cluster_admins : name => {
    ...
    principal_arn = "arn:aws:iam::222222222222:user/${user.email}"
    policy_associations = {
    ...
    authentik_oidc_admin = {
      ...
      principal_arn = "arn:aws:iam::222222222222:role/authentik-oidc-admin"
      policy_associations = {
        cluster_admin_policy = {
          policy_arn = "arn:aws:eks::aws:cluster-access-policy/AmazonEKSClusterAdminPolicy"
          access_scope = {
    ...
    authentik_oidc_developer = {
      ...
      principal_arn = "arn:aws:iam::222222222222:role/authentik-oidc-developer"
      policy_associations = {
        developer_policy = {
          policy_arn = "prd" == "dev" ? "arn:aws:eks::aws:cluster-access-policy/AmazonEKSEditPolicy" : "arn:aws:eks::aws:cluster-access-policy/AmazonEKSViewPolicy"
          access_scope = {
            type       = "cluster"
            namespaces = null
          }
    ...
    github_actions = {
      ...
      principal_arn = "arn:aws:iam::222222222222:role/GitHubActions"
      policy_associations = {
        cluster_admin_policy = {
          policy_arn = "arn:aws:eks::aws:cluster-access-policy/AmazonEKSClusterAdminPolicy"
          access_scope = {
    ...
    dev_scaler_lambda = {
      ...
      principal_arn = "arn:aws:iam::222222222222:role/dev-scaler-lambda-dev-role"
      policy_associations = {
        cluster_admin_policy = {
          policy_arn = "arn:aws:eks::aws:cluster-access-policy/AmazonEKSClusterAdminPolicy"
          access_scope = {
