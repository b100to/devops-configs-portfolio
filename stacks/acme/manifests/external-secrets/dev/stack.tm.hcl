stack {
  name        = "acme_manifests_external_secrets_v2_dev"
  id          = "acme_manifests_external-secrets_v2_dev"
  description = "manifests external-secrets"
  tags        = ["stack", "aws", "acme", "manifests", "external_secrets", "v2", "dev"]
  after = [
    "tag:dev:helm:external_secrets",
  ]
}
