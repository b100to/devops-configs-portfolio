stack {
  name        = "acme_manifests_external_secrets_v2_prd"
  id          = "acme_manifests_external-secrets_v2_prd"
  description = "manifests external-secrets"
  tags        = ["stack", "aws", "acme", "manifests", "external_secrets", "v2", "prd"]
  after = [
    "tag:prd:helm:external_secrets",
  ]
}
