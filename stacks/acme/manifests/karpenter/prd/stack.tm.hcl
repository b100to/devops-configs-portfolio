stack {
  name = "acme_manifests_karpenter_v2_prd"
  id   = "acme_manifests_karpenter_v2_prd"
  tags = ["stack", "aws", "acme", "manifests", "karpenter", "v2", "prd"]
  after = [
    "tag:prd:eks",
    "tag:prd:helm:karpenter",
  ]
}

input "node_iam_role_arn" {
  backend       = "default"
  from_stack_id = "acme_helm_karpenter_v2_prd"
